#Model M1 MRR Determination: Deterministic Redispatch Model for EL + NG Coordination => Determine the value of MRR by iteratively solving the deterministic coordination problem and checking redispatch
...
SimResults_with_MRR = CSV.read("results/MRR_Results.csv")
NumScenarios = 500
